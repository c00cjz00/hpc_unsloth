...
model, tokenizer = FastLanguageModel.from_pretrained(
    ...
    model_name = "unsloth/Mistral-Small-24B-Base-2501",
...
dataset = load_dataset("c00cjz00/Medical-R1-Distill-Data", split = "train")
...
if True: model.push_to_hub_merged("c00cjz00/Mistral-Small-24B-Base-2501-R1-medical", tokenizer, save_method = "merged_16bit", token = "hf_")
